...
<style>
  ...
  .palco-cartao{ width:calc(720px * .34); height:calc(1080px * .34); background:var(--card); }
...
<div class="man-wrap">
  ...
  <div class="sec">
    ...
    <table class="tb" style="margin-top:.8rem">
      ...
      <tr><th>Volutas</th><td><?= escP(cartaoVoluta($defs['cartao.voluta'])['nome']) ?> —
        cantos superior-esquerdo e inferior-direito (rodada 180°), caixa
