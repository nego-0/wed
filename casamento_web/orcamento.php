...
<style>
  ...
  .kpi .n{ font-family:var(--serif); font-size:var(--t-display); font-weight:700; color:var(--ink); line-height:1.05;
           font-variant-numeric:tabular-nums; }
  .kpi .n small{ font-size:var(--t-denso); color:var(--ink-fraco); font-weight:400; }
  .kpi .l{ font-size:var(--t-etiqueta); font-weight:600; text-transform:uppercase; letter-spacing:.06em; color:var(--ink-fraco); margin-top:.3rem; }
  ...
  .o-cat .vals{ font-size:var(--t-apoio); color:var(--ink-fraco); margin-top:.15rem; font-variant-numeric:tabular-nums; }
  ...
  .o-cat .pct{ position:absolute; top:.8rem; right:.9rem; font-size:var(--t-apoio); font-weight:700;
  ...
  .mini{ font-size:var(--t-apoio); color:var(--ink-fraco); background:transparent; border:1px solid var(--line);
  ...
  .o-catbar-vazio{ color:var(--ink-fraco); font-size:var(--t-denso); padding:.2rem .3rem; }
  ...
  .o-filtro .o-filtro-est{ font-weight:600; border-radius:50px; padding:.1rem .6rem;
        font-size:var(--t-apoio); background:var(--cream); color:var(--ink); }
  ...
  /* O que ainda falta pagar, por baixo do valor — só aparece quando as duas
     ...
     prestação. */
  .d-falta{ font-size:var(--t-apoio); font-weight:400; color:var(--warn); }
  ...
  .o-mes{ font-size:var(--t-etiqueta); text-transform:uppercase; letter-spacing:.06em; color:var(--ink-fraco);
  ...
  .pag .data{ font-variant-numeric:tabular-nums; font-size:var(--t-denso); color:var(--ink); white-space:nowrap;
