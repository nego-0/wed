...
**Zoom.** A **barra de zoom** tem três níveis: **50%** (vista ampla), **100%** (vista panorâmica padrão, que usa **todo o espaço do canvas**) e **150%** (vista de área). Ao ampliar, a planta cresce dentro de uma área com deslocamento (scroll).
