...
**Mesa dos noivos.** A planta tem **sempre**, por padrão, uma **pastilha especial** dos noivos — com uma ilustração própria (as alianças entrelaçadas) — para representar o casal. É propositadamente **um pouco menor** que as mesas dos convidados, só existe uma e não pode ser eliminada. As suas **alas laterais** (padrinhos à esquerda, madrinhas à direita) são preenchidas **automaticamente pelo papel de cada convidado**: quem tiver o papel *Padrinho* entra na ala esquerda e quem tiver *Madrinha* na ala direita, sem atribuição manual. O papel define-se no **editor do convite** (cada integrante tem um seletor *Convidado / Padrinho / Madrinha*) ou diretamente no painel da mesa dos noivos. **Só padrinhos e madrinhas** podem ficar nesta mesa — nenhum outro convidado lhe pode ser atribuído.

**Zoom.** A **barra de zoom** tem três níveis: **50%** (vista ampla), **100%** (vista panorâmica padrão) e **150%** (vista de área). Ao ampliar, a planta cresce dentro de uma área com deslocamento (scroll).
